...
namespace usineJusFruit.Utilities.DataAccess
{
    public abstract class DataAccess : IDataAccess
    {
        ...
        public abstract ReservationsCollection EnterClientGetReservations(Client client);

        public abstract bool UpdateAllClients(ClientsCollection clients);

        public abstract bool UpdateAllReservations(ReservationsCollection clients);
